...
class MaskRCNN(keras.Model):
    ...
    def call(self, inputs):
        ...
        if mode == "training":
            ...
            input_anchors = inputs["input_anchors"]
        ...
        # SL: not supported for now, since MaskRCNN is itself a keras model
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        try:
            ...
            print ('Error sl: from keras.engine import saving')
        ...
        layers = self.inner_model.layers if hasattr(self, "inner_model")\
            else self.layers
...
class MaskRCNN_test():
    ...
    def build(self, mode, config):
        ...
        # for i, md in enumerate(layer_outputs,0):
        #     print("md %d is %s" % (i,md) )

        # print (type(layer_outputs[0][0]))
        ...
        # print("outputs is \n %s \n ant its len is %d \n\n " % (outputs, len(outputs)) )
        # print(zip(outputs, output_names))
        # for o,p in zip(outputs, output_names): 
        #     print(o)
        #     print(list(o))
        #     print(KL.Concatenate(axis=1, name=p)(list(o)))
        #     print(o[0].shape)
        #     print(p)
